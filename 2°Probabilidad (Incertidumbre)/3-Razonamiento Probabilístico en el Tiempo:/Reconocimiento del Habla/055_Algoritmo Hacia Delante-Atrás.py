...
estados = ['A', 'B']
observaciones = ['X', 'Y']
transiciones = np.array([[0.7, 0.3],  # Probabilidad de transición entre estados
                         [0.4, 0.6]])

emisiones = np.array([[0.5, 0.5],  # Probabilidad de observación dado el estado
                      [0.1, 0.9]])

# Inicializar las probabilidades de las observaciones
prob_inicial = np.array([0.5, 0.5])  # Probabilidades iniciales de los estados
