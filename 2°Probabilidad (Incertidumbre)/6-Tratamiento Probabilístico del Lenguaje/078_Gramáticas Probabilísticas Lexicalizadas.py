# Importando la librería random para realizar selecciones aleatorias basadas en probabilidades
import random

# Definición de la clase PCFG (Gramática probabilística de contexto libre)
class PCFG:
    def __init__(self):
        """
        Inicializa la gramática probabilística de contexto libre (PCFG).
        Define las reglas de producción con las probabilidades correspondientes para cada regla.
        """
    ...
    def generate(self, non_terminal):
        ...
        """
        # Obtener todas las producciones posibles para el símbolo no terminal actual
        ...
        # Unir las partes generadas en una cadena de texto para formar la oración completa
        return ' '.join(result)
